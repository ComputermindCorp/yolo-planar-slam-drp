...
int main(int argc, char** argv) {
    if (argc != 3) {
        cerr << endl
             << "Usage: ./mono_usbcam path_to_vocabulary path_to_settings" << endl;
        return 1;
    }
    ...
    ORB_SLAM2::System SLAM(argv[1], argv[2], InputType::MONO_CAMERA, eSensor::MONOCULAR, bUsePangolinViewer, bUseSocketViewer, drp_dev_num, drp_ai_dev_num);
