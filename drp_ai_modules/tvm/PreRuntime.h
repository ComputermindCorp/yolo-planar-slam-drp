...
public:
    ...
    uint8_t Load(const std::string pre_dir, uint32_t area_size, uint8_t mode = MODE_PRE);
...
private:
    ...
    /*Since passing vector type arguments causes a stack overflow, we changed to address passing.更*/
